# Code borrowed from schnetpack, see https://github.com/atomistic-machine-learning/schnetpack
...
import schnetpack_gschnet.properties as properties
import schnetpack.nn as snn


__all__ = ["PaiNN", "PaiNNInteraction", "HardCutoff", "PaiNNMixing"]
...
class PaiNN(nn.Module):
    ...
    def forward(self, inputs: Dict[str, torch.Tensor]):
        ...
        dir_ij = torch.where(torch.isnan(dir_ij), torch.tensor(1e-4, device=dir_ij.device), dir_ij)
